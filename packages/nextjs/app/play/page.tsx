...
export default function PlayPage() {
  ...
  const mySeatIndex = playerIds.findIndex((id) => id === currentWalletId);
  const isSittingOut =
  ...
  const handleLeaveTable = useCallback(async () => {
    if (walletSeatIdx < 0 || isLeaving) return;
    ...
    >
        ...
        {walletSeatIdx >= 0 && (
          <div className="header-actions">
            ...
            <button
              ...
              disabled={isLeaving || connectionState === "disconnected"}
              className={`action-btn leave ${
                isLeaving || connectionState === "disconnected"
                  ? "disabled"
                  : ""
              }`}
      ...
      <style jsx>{`
        ...
        .control-actions {
          ...
          justify-content: center;
          align-items: center;
          /* Ensure enough space for buttons + slider inside the card */
